...
private
   ...
   type Unmanaged_Set_Iterator is new Set_Iterator with null record;

   procedure Reset (It : in out Unmanaged_Set_Iterator);

   procedure Next (It : in out Unmanaged_Set_Iterator);

   function Is_Done (It : Unmanaged_Set_Iterator) return Boolean;

   function Current_Item (It : Unmanaged_Set_Iterator) return Item;

   function Current_Item_Ptr (It : Unmanaged_Set_Iterator) return Item_Ptr;

   procedure Delete_Item_At (It : in out Unmanaged_Set_Iterator);
