...
--!  Get_Message is completly static and need no changes at all.
----------------------------------------------------------------
separate (DXPL.Round_Function)

function Get_Message (Index : in Positive) return Word_Array is
begin
	return Test_Vectors.Batch (Index).Message.all;
end Get_Message;