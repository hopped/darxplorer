...
package body BC.Containers.Bags.Unmanaged is
   ...
   procedure Reset (It : in out Unmanaged_Bag_Iterator) is
   ...
   procedure Next (It : in out Unmanaged_Bag_Iterator) is
      S : Unconstrained_Bag'Class
        renames Unconstrained_Bag'Class (It.For_The_Container.all);
   begin
   ...
   function Is_Done (It : Unmanaged_Bag_Iterator) return Boolean is
      S : Unconstrained_Bag'Class
        renames Unconstrained_Bag'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item (It : Unmanaged_Bag_Iterator) return Item is
      S : Unconstrained_Bag'Class
        renames Unconstrained_Bag'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item_Ptr (It : Unmanaged_Bag_Iterator) return Item_Ptr is
      S : Unconstrained_Bag'Class
        renames Unconstrained_Bag'Class (It.For_The_Container.all);
   begin
   ...
   procedure Delete_Item_At (It : in out Unmanaged_Bag_Iterator) is
      S : Unconstrained_Bag'Class
        renames Unconstrained_Bag'Class (It.For_The_Container.all);
   begin
