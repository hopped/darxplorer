...
--!    * EXPRESSION (POSITIVE)
--!
--!  Simple rotation. The first parameter can itself be an expression.
--!  Compiler has to accept.
------------------------------------------------------------------------
procedure Expression_P_10 is
    ...
    begin
        Message (0) := DXPL_Types_32.Rotate_Left (Message (0) and Message (1), 20);
    end DXPL_Process;
