...
package body BC.Support.Indefinite_Bounded is
   ...
   begin
      ...
      Obj.Size := Obj.Size + 1;
      Obj.Elems (Obj.Start) := Smart.Create (Value => Elem);
   end Insert;
      ...
      if Obj.Size = 0 or else Before = 1 then
         ...
         begin
            if Start = 1 or else Start > Actual then
               ...
               Obj.Elems (Actual) := Smart.Create (Value => Elem);
               ...
               Start := Start - 1;
               Obj.Elems (Actual - 1) := Smart.Create (Value => Elem);
   ...
   begin
      ...
      return Smart.Value (Obj.Elems (Obj.Start));
   end First;
...
end BC.Support.Indefinite_Bounded;
