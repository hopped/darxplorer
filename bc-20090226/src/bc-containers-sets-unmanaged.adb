...
package body BC.Containers.Sets.Unmanaged is
   ...
   procedure Reset (It : in out Unmanaged_Set_Iterator) is
   ...
   procedure Next (It : in out Unmanaged_Set_Iterator) is
      S : Unconstrained_Set'Class
        renames Unconstrained_Set'Class (It.For_The_Container.all);
   begin
   ...
   function Is_Done (It : Unmanaged_Set_Iterator) return Boolean is
      S : Unconstrained_Set'Class
        renames Unconstrained_Set'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item (It : Unmanaged_Set_Iterator) return Item is
      S : Unconstrained_Set'Class
        renames Unconstrained_Set'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item_Ptr (It : Unmanaged_Set_Iterator) return Item_Ptr is
      S : Unconstrained_Set'Class
        renames Unconstrained_Set'Class (It.For_The_Container.all);
   begin
   ...
   procedure Delete_Item_At (It : in out Unmanaged_Set_Iterator) is
      S : Unconstrained_Set'Class
        renames Unconstrained_Set'Class (It.For_The_Container.all);
   begin
...
end BC.Containers.Sets.Unmanaged;
