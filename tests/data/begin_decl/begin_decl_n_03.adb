...
--!
--!  Two occurrences of DXPL_Types.Configuration are not allowed.
--!  Compiler should mumble.
------------------------------------------------------------------------
procedure Begin_Decl_N_03 is
...
begin
    ...
    DXPL_Types_32.Configuration
        (DXPL_ALGORITHM   => "Rogue Hash",
         DXPL_ROUNDS      => 11,
         DXPL_TERMINATION => 254);
