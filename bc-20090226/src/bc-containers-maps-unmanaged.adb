...
package body BC.Containers.Maps.Unmanaged is
   ...
   procedure Reset (It : in out Unmanaged_Map_Iterator) is
   ...
   procedure Next (It : in out Unmanaged_Map_Iterator) is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
   ...
   function Is_Done (It : Unmanaged_Map_Iterator) return Boolean is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Key (It : Unmanaged_Map_Iterator) return Key is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item (It : Unmanaged_Map_Iterator) return Item is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
   ...
   function Current_Item_Ptr (It : Unmanaged_Map_Iterator) return Item_Ptr is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
   ...
   procedure Delete_Item_At (It : in out Unmanaged_Map_Iterator) is
      S : Unconstrained_Map'Class
        renames Unconstrained_Map'Class (It.For_The_Container.all);
   begin
