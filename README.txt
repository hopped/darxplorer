# Last update on 09/23/2009 by hoppe
...
tools for analysation. DARXplorer offers a convenient way to describe
...
2/3, and the last bit is definitly 0 and is never equals 1.
...
or higher. More information can be found here
...
for more information. The version we used is include in this 
distribution and is contained in the directory 'bc-20090226'.


4. Copyright and Author

DARXplorer was written by Dennis Hoppe, Julian Seifert and 
Stoyan Stoyanov and Max Grosse under the supervision of Stefan Lucks.
